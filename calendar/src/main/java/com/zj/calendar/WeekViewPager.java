...
public final class WeekViewPager extends ViewPager {
    ...
    private void init() {
        ...
        addOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (view != null) {
                    view.performClickCalendar(mDelegate.getSelectMode() != CalendarViewDelegate.SELECT_MODE_DEFAULT ? mDelegate.mIndexCalendar : mDelegate.mSelectedCalendar, !isUsingScrollToCalendar);
    ...
    List<Calendar> getCurrentWeekCalendars() {
        if (mDelegate.mIndexCalendar == null) return new ArrayList<>();
        List<Calendar> calendars = CalendarUtil.getWeekCalendars(mDelegate.mIndexCalendar, mDelegate);
        mDelegate.addSchedulesFromMap(calendars);
        return calendars;
    }
    ...
    private class WeekViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            BaseWeekView view = null;
            try {
                Class<?> cls = mDelegate.getWeekViewClass();
                if (cls != null) {
